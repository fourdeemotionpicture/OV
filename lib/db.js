...
// Connect PostgreSQL when DATABASE_URL is provided, or operate with resilient embedded store fallback
if (DATABASE_URL) {
  try {
    ...
    console.warn('[OV DB] pg connection initialization failed; operating with embedded store fallback:', err.message);
  }
} else {
